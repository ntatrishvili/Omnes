...
class GridComponent(Entity):
    ...
    def __init__(self, id: Optional[str] = None, ts_factory: TimeseriesFactory = None, **kwargs):
        ...
        self.quantities.update({"phase_count": Constant(value=kwargs.get("phase_count", self.default_phase_count)),
    ...
    def check_kwargs(**kwargs):
        ...
        if phase_count not in (1, 3):
            raise ValueError("Bus phase count set incorrectly. Phase count must be 1 or 3.")
